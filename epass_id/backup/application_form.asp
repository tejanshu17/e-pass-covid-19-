...
<div class ="sign-in">
	...
	<form name = "form1" action = "create_epass_id.asp" method = "post">
		...
		Last Name/नाम: <input type = "text" value = <% Response.Write(lname) %> name = "applicant_name"><br><br>
	 	Adhaar card no/आधार कार्ड नंबर: <input type = "number" name = "applicant_adhaar_no"><br><br>
		...
		<select id="applicant_reason" name="applicant_reason">
			<option value="supermarket/सुपरमार्केट">Labour Group/श्रमिक समूह</option>
			<option value="supermarket/सुपरमार्केट">Stranded Student/फंसे हुए छात्र</option>
			<option value="supermarket/सुपरमार्केट">Stranded Individual/फंसे हुए व्यक्ति</option>
			<option value="supermarket/सुपरमार्केट">Bank/बैंक</option>
			<option value="supermarket/सुपरमार्केट">Cable TV/केबल टीवी</option>
			<option value="supermarket/सुपरमार्केट">Goverment/सरकार</option>
  			<option value="supermarket/सुपरमार्केट">Medical (Pharmacy Shop)/मेडिकल (फार्मेसी की दुकान)
</option>
		...
		<b><u> Start Date & Time(24 Hour Format)/प्रारंभ तिथि और समय (24 घंटे का प्रारूप): </u> </b> <br> <br>
			...
			<label for="applicant_start_date_day">Month/महीना:</label>
		...
		<b><u> End Date & Time(24 Hour Format):</u></b> <br> <br>
			...
			<label for="applicant_end_date_day">Month/महीना:</label>
			<input type = "number" id = "applicant_end_date_month" name = "applicant_end_date_month" style="width: 50px;"> &nbsp;
			
			<label for="applicant_end_date_month">Day/दिन:</label>
