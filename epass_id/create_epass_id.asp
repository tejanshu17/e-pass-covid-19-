...
<%
    ...
    newid = lastid+1
	applicant_start_date = applicant_start_date_month&"-"&applicant_start_date_day&"-"&applicant_start_date_year
	...
	applicant_end_date = applicant_end_date_month&"-"&applicant_end_date_day&"-"&applicant_end_date_year
